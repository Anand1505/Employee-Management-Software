...
public class Department extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel3.setText("Overtime Status");

        jComboBox1.setFont(new java.awt.Font("Times New Roman", 0, 24)); // NOI18N
        jComboBox1.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Select Any One..", "Yes", "No" }));

        jLabel4.setFont(new java.awt.Font("Times New Roman", 0, 18)); // NOI18N
        jLabel4.setText("Rate(OT/HR)");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        String sql="insert into department(Name,Overtime,Rate,Description) values(?,?,?,?)";
        try
        {
            ...
            st.execute();
            JOptionPane.showMessageDialog(null, "Department Insertion Successful");
        }
        catch(Exception ex)
        {
